...
wt -w 0 ^
  ...
  nt --title "4. Sat" -d "%ROOT_DIR%\Satellite" cmd /k "title 4. Sat && npm run dev -- --port 8003" ; ^
  nt --title "5. Edit" -d "%ROOT_DIR%\Editor_Service" cmd /k "title 5. Edit && npm start -- --port 8004" ; ^
